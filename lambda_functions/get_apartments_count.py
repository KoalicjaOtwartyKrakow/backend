...
def lambda_handler(event, context):
    ...
    value_by_cnt['TOTAL'] ={'TOTAL_USERS':0, 'TOTAL_PLACES':0, 'TOTAL_PLACES_BUSY':0}
    for d in data:
        if value_by_cnt[d['CNT_NAME']] == 0:
            value_by_cnt[d['CNT_NAME']] ={'TOTAL_USERS':0, 'TOTAL_PLACES':0, 'TOTAL_PLACES_BUSY':0}
