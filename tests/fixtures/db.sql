...
INSERT INTO hosts(full_name, phone_number, email, call_after, call_before, comments, guid, system_comments)
...
INSERT INTO accommodation_units(guid, address_line, city, zip, voivodeship, vacancies_total,
                                vacancies_free, host_id, owner_comments, staff_comments, for_how_long,
                                system_comments)
...
INSERT INTO guests(guid, full_name, email, phone_number, children_ages, updated_by_id, accommodation_unit_id,
                   document_number, pets_description, special_needs, food_allergies, finance_status,
                   how_long_to_stay, desired_destination, staff_comments, system_comments)
